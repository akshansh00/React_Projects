...
const Projects = () => {
    ...
    useEffect(() => {
      const updatCardsToShow = ()=>{
        ...
        return ()=> window.removeEventListener('resize', updatCardsToShow);
  ...
  return (
    ...
    lg:px-32 my-20 w-full overflow-hidden' id='Projects'>
      ...
      text-center'>Projects <span className="underline underline-offset-4
      decoration-1 under font-light">Completed</span></h1>
      <p className='text-center text-gray-500 mb-8
      max-w-80 mx-auto'>Crafting Spaces, Building Legacies-Explore Our Portfolio</p>
